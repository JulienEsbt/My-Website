...
const Contact = () => {
    const {t} = useTranslation() // namespace par défaut: common
            ...
            <div className="container contact__container">
                ...
                <div className="contact__options" ref={imgRef}>
                    <article className="contact__option" ref={(el) => (cardsRef.current[0] = el)}>
                        <MdOutlineEmail className="contact__option-icon" aria-hidden/>
                        <h4>{t('contact.options.email.title')}</h4>
                        <h5>{t('contact.options.email.value')}</h5>
                        <a
                            href={`mailto:${LINKS.mail.personal}`}
                            target="_blank"
                            rel="noreferrer noopener"
                            aria-label={`${t('contact.options.email.cta')} (${LINKS.mail.personal})`}
                        >
                    ...
                    <article className="contact__option" ref={(el) => (cardsRef.current[1] = el)}>
                        <FaLinkedin className="contact__option-icon" aria-hidden/>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer noopener"
                            aria-label={`${t('contact.options.linkedin.cta')} (LinkedIn)`}
                        >
                    ...
                    <article className="contact__option" ref={(el) => (cardsRef.current[2] = el)}>
                        <FaTwitter className="contact__option-icon" aria-hidden/>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer noopener"
                            aria-label={`${t('contact.options.twitter.cta')} (Twitter/X)`}
                        >
