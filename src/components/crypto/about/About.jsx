                ...
                <div className="about__content">
                    <div className="about__cards">
                        <article className="about__card" ref={(el) => (cardsRef.current[0] = el)}>
                            ...
                            <h5>{t('about.cards.passionTitle')}</h5>
                            <small>{t('about.cards.passionText')}</small>
                        </article>
                        ...
                        <article className="about__card" ref={(el) => (cardsRef.current[1] = el)}>
                            ...
                            <h5>{t('about.cards.investingTitle')}</h5>
                            <small>{t('about.cards.investingText')}</small>
                        </article>
                        ...
                        <article className="about__card" ref={(el) => (cardsRef.current[2] = el)}>
                            ...
                            <h5>{t('about.cards.devTitle')}</h5>
                            <small>{t('about.cards.devText')}</small>
                        </article>
                    </div>
